...
import app.linkbac.fmd.draw.StylusVisualization.drawOrientation
import app.linkbac.fmd.draw.StylusVisualization.drawPressure
import app.linkbac.fmd.draw.StylusVisualization.drawTilt
import kotlin.math.PI
import kotlin.math.cos
import kotlin.math.sin

@Composable
fun StylusVisualization(modifier: Modifier = Modifier, viewModel: StylusViewModel) {
